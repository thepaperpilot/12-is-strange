...
public class Main extends Game {
    ...
    public void create() {
        ...
        manager.load("vortexBackground.png", Texture.class);
        manager.load("officeBackground.png", Texture.class);
        manager.load("dormBackground.png", Texture.class);
        manager.load("breakableDoorPuzzle.png", Texture.class);
        manager.load("schoolDoorKeypad.png", Texture.class);
        manager.load("fireAlarmPuzzle.png", Texture.class);
        manager.load("fireAlarmPuzzleBroken.png", Texture.class);
        manager.load("AlyssaSoapPuzzle.png", Texture.class);
        manager.load("carPuzzle.png", Texture.class);
        manager.load("warrenPuzzle.png", Texture.class);
        manager.load("bouncer.png", Texture.class);
        manager.load("tirestack.png", Texture.class);
        ...
        manager.load("dogHappy.png", Texture.class);
        ...
        manager.load("blueJayIdle.png", Texture.class);
        manager.load("blueJayDead.png", Texture.class);

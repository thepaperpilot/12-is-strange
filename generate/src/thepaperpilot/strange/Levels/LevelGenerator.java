    ...
    public static void main(String[] args) {
        new LwjglApplication(new Game() {
            ...
            public void create() {
                ...
                scene = new Scene.ScenePrototype("eighth", "vortex", "seventh");
                scene.obstacles.put("bouncer", new Rectangle(192, 0, 16, 60));
                entities = new ArrayList<Entity.EntityPrototype>();
                entity = new Entity.EntityPrototype(null, "CLOCK", 192, 96, true, null);
                entity.attributes.put("texture", "clock");
                entity.attributes.put("numFrames", "12");
                entity.attributes.put("time", "8");
                entities.add(entity);
                // bouncer
                entity = new Entity.EntityPrototype("bouncer", "IMAGE", 192, 10, true, new String[]{"alcohol"});
                entity.attributes.put("texture", "bouncer");
                effects = new ArrayList<Effect.EffectPrototype>();
                effect = new Effect.EffectPrototype();
                effect.type = "REMOVE_BARRIER";
                effect.attributes.put("targetScene", "eighth");
                effect.attributes.put("targetObstacle", "bouncer");
                effects.add(effect);
                effect = new Effect.EffectPrototype();
                effect.type = "SAY";
                effect.attributes.put("targetScene", "eighth");
                effect.attributes.put("message", "here you go");
                effects.add(effect);
                effect = new Effect.EffectPrototype();
                effect.type = "REMOVE_ITEM";
                effect.attributes.put("targetItem", "alcohol");
                ...
                effect.type = "SAY";
                effect.attributes.put("targetScene", "eighth");
                effect.attributes.put("message", "I'm not allowed in the VIP area. Maybe if I brought him some alcohol");
                effects.add(effect);
                entity.failEffects = Arrays.copyOf(effects.toArray(), effects.size(), Effect.EffectPrototype[].class);
                effects = new ArrayList<Effect.EffectPrototype>();
                effect = new Effect.EffectPrototype();
                ...
                entities.add(entity);
                // fire extinguisher
                entity = new Entity.EntityPrototype("fire extinguisher", "IMAGE", 10, 16, true, null);
                entity.attributes.put("texture", "fireExtinguishWorld");
                effects = new ArrayList<Effect.EffectPrototype>();
                effect = new Effect.EffectPrototype();
                effect.type = "ADD_ITEM";
                ...
                effect.type = "REMOVE_ENTITY";
                effect.attributes.put("targetScene", "eighth");
                effect.attributes.put("targetEntity", "fire extinguisher");
                effects.add(effect);
                entity.successEffects = Arrays.copyOf(effects.toArray(), effects.size(), Effect.EffectPrototype[].class);
                entities.add(entity);
                scene.entities = Arrays.copyOf(entities.toArray(), entities.size(), Entity.EntityPrototype[].class);
                ...
                effect.attributes.put("message", "now warren will let me past");
                effects.add(effect);
                entity.successEffects = Arrays.copyOf(effects.toArray(), effects.size(), Effect.EffectPrototype[].class);
                effects = new ArrayList<Effect.EffectPrototype>();
                effect = new Effect.EffectPrototype();
                ...
                entities.add(entity);
                // detective
                entity = new Entity.EntityPrototype("warren", "IMAGE", 48, 16, true, new String[]{"phone", "photo", "files"});
                ...
                effect = new Effect.EffectPrototype();
                effect.type = "ADD_ITEM";
                effect.attributes.put("targetItem", "fortune cookie");
                effects.add(effect);
                effect = new Effect.EffectPrototype();
                effect.type = "REMOVE_ITEM";
                effect.attributes.put("targetItem", "phone");
                ...
                effect.type = "SAY";
                effect.attributes.put("targetScene", "eleventh");
                effect.attributes.put("message", "He may have been mysterious, but at least he was helpful");
                effects.add(effect);
                entity.doneEffects = Arrays.copyOf(effects.toArray(), effects.size(), Effect.EffectPrototype[].class);
                entities.add(entity);
                scene.entities = Arrays.copyOf(entities.toArray(), entities.size(), Entity.EntityPrototype[].class);
                ...
                scene = new Scene.ScenePrototype("twelfth", "school", "tenth");
                entities = new ArrayList<Entity.EntityPrototype>();
                entity = new Entity.EntityPrototype(null, "CLOCK", 192, 96, true, null);
                entity.attributes.put("texture", "clock");
                entity.attributes.put("numFrames", "12");
                entity.attributes.put("time", "12");
                entities.add(entity);
                // door
                entity = new Entity.EntityPrototype("door", "IMAGE", 48, 16, true, new String[]{"fortune cookie code"});
                entity.attributes.put("texture", "schoolDoorKeypad");
                effects = new ArrayList<Effect.EffectPrototype>();
                effect = new Effect.EffectPrototype();
                effect.type = "SAY";
                effect.attributes.put("targetScene", "twelfth");
                effect.attributes.put("message", "it worked! how exciting!");
                effects.add(effect);
                effect = new Effect.EffectPrototype();
                effect.type = "REMOVE_ITEM";
                effect.attributes.put("targetItem", "fortune cookie code");
                effects.add(effect);
                entity.successEffects = Arrays.copyOf(effects.toArray(), effects.size(), Effect.EffectPrototype[].class);
                effects = new ArrayList<Effect.EffectPrototype>();
                effect = new Effect.EffectPrototype();
                effect.type = "SAY";
                effect.attributes.put("targetScene", "twelfth");
                effect.attributes.put("message", "it's locked with a keypad. Now where could I find the code?");
                effects.add(effect);
                entity.failEffects = Arrays.copyOf(effects.toArray(), effects.size(), Effect.EffectPrototype[].class);
                effects = new ArrayList<Effect.EffectPrototype>();
                effect = new Effect.EffectPrototype();
